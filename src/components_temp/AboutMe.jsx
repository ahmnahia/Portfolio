    ...
    >
      ...
      <div className="container">
        ...
        <div className="border-l-4 border-r-4 border-blue-600  dark:border-orange-600 px-4 py-10 text-xl rounded-lg shadow-md dark:shadow-zinc-900 bg-blue-50 dark:bg-zinc-800 text-black dark:text-white font-light  mt-5 text-justify leading-8">
          I{"'"}m a computer science graduate, currently working at iHorizons
          Qatar, with a passion for software development, particularly in the
          web space. Some technologies I enjoy are Node.js, React.js, and
          Tailwind CSS. I{"'"}m always eager to learn new tools and skills to
          keep up with industry trends and get better at what I do.
        </div>
